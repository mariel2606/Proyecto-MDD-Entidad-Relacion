...
namespace UPM_IPS.JMGPVRCMAMBModeladoYLenguajeGrafico
{
	...
	/// </remarks>
	public partial class JMGPVRCMAMBModeladoYLenguajeGraficoHelpKeywordHelper : JMGPVRCMAMBModeladoYLenguajeGraficoHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new JMGPVRCMAMBModeladoYLenguajeGraficoHelpKeywordHelper.
		/// </summary>
		protected JMGPVRCMAMBModeladoYLenguajeGraficoHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the JMGPVRCMAMBModeladoYLenguajeGraficoHelpKeywordHelper.
		/// </summary>
		public static JMGPVRCMAMBModeladoYLenguajeGraficoHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class JMGPVRCMAMBModeladoYLenguajeGraficoHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new JMGPVRCMAMBModeladoYLenguajeGraficoHelpKeywordHelperBase.
		/// </summary>
		protected JMGPVRCMAMBModeladoYLenguajeGraficoHelpKeywordHelperBase()
			: base() { }
